<?php
/**
 * Postmedia_Sniffs_Files_LowercasedFilenameSniff.
 * Copy of Generic_Sniffs_Files_LowercasedFilenameSniff.
 *
 * PHP version 5
 *
 * @category  PHP
...
/**
 * Checks that all file names are lowercased, exceptions given to files within an accepted path
 *
 * @category  PHP
 * @package   PHP_CodeSniffer
 * @author    Andy Grunwald <andygrunwald@gmail.com>
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Postmedia_Sniffs_Files_LowercasedFilenameSniff implements PHP_CodeSniffer_Sniff {
